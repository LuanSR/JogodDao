...
public class FrmLivros extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtExcluir, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            c1.cadastrarLivro(Codigo, Nome, Categoria);
        } catch (SQLException ex) {
            Logger.getLogger(FrmLivros.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja excluir " + Codigo + "?");
        if (resposta==0)
        try {
            c1.excluirLivro(Codigo);
        } catch (SQLException ex) {
            Logger.getLogger(FrmLivros.class.getName()).log(Level.SEVERE, null, ex);
        }
